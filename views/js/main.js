...
var resizePizzas = function(size) { 
	...
	/*
		RE: Everytime the script referenced the pizza containers it would rerun the selector query
		You only need to run the selector once and store it in a variable.
	*/
...
function updatePositions() {
	...
	// RE: Moving the calculation of the offset from top saves us from computing it every single time in the loop
	var topOffsetPos = (document.body.scrollTop / 1250);
	for (var i = 0; i < items.length; i++) {
		var phase = Math.sin(topOffsetPos + (i % 5));
